 ...
 */
public class GroupCreateAdapter extends RecyclerView.Adapter<GroupCreateAdapter.ItemHolder> {

    private Context context;
    private ArrayList<ContactBean> list;
    private OnItemClickListener onItemClick;

    public GroupCreateAdapter(Context context, ArrayList<ContactBean> list) {
    ...
    public ItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ItemHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.create_group_row, parent, false));
    }
