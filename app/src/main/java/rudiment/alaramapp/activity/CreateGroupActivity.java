...
import rudiment.alaramapp.adapter.GroupCreateAdapter;
...
public class CreateGroupActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        mMyToDoRecyclerView = (RecyclerView) findViewById(R.id.list);
    ...
    private void showCreateGroupPopup() {
        ...
        dialog.setContentView(R.layout.create_group_popup);
...
//This makes the dialog take up the full width
    ...
    private void setContactList(final ArrayList<ContactBean> list) {
        ...
        GroupCreateAdapter contactAdapter = new GroupCreateAdapter(CreateGroupActivity.this, list);
    ...
    private void switchActivity(final ContactBean item) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                pDialog.dismiss();
                startActivity(new Intent(CreateGroupActivity.this, ChatScreenActivity.class)
        ...
        new Permissive.Request(Manifest.permission.READ_CONTACTS)
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (json != null && !json.isEmpty()) {
                                    ...
                                    Utility.showToast(CreateGroupActivity.this, getString(R.string.wrong));
                                }
                            }
                        }).start();
                    }
                ...
                .whenPermissionsRefused(new PermissionsRefusedListener() {
                    ...
                    public void onPermissionsRefused(String[] permissions) {
                        ...
                        Utility.showToast(CreateGroupActivity.this, getString(R.string.contact_permission_rejected_msg));
                    }
                })
                .execute(CreateGroupActivity.this);
    }
            ...
            public void onResult(String result) {
                ...
                if (result != null && !result.isEmpty()) {
                    ...
                    if (contactResponceBean.responseCode.equals("200")) {
                        ...
                        Utility.showToast(CreateGroupActivity.this, contactResponceBean.responseMessage);
                    }
                } else {
                    Utility.showToast(CreateGroupActivity.this, getString(R.string.wrong));
                }
